...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'spectrogram.jobs.step1.title': 'Enter Your Coupon Code',
    'spectrogram.jobs.step1.desc': 'Use the unique code provided in your application',
  ...
  fr: {
    ...
    'spectrogram.jobs.step1.title': 'Entrez Votre Code Coupon',
    'spectrogram.jobs.step1.desc': 'Utilisez le code unique fourni dans votre candidature',
    ...
    'spectrogram.jobs.couponPlaceholder': 'Entrez votre code coupon',
    'spectrogram.jobs.apply': 'Appliquer le Code & Commencer',

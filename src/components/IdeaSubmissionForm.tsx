...
export function IdeaSubmissionForm({ compact = false }: IdeaSubmissionFormProps) {
  ...
  return (
    <div className={`grid ${compact ? 'lg:grid-cols-5' : 'lg:grid-cols-5'} gap-8 max-w-6xl mx-auto`}>
      {/* Left Column - Info */}
      <div className="lg:col-span-2">
        <div className="bg-foreground text-background rounded-2xl p-8 h-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Record a 3-minute (max) video explaining your idea.
              </p>

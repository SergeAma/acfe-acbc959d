...
const getContractConditions = (sessionPriceDollars: number) => [
  ...
  },
  {
    ...
    description: "I agree that ACFE reserves the right to publicly share and promote any positive outcomes as a result of a student's learning & mentorship experience."
  }
];

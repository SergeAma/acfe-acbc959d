    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden">
          ...
          <div className="absolute top-20 right-[15%] w-72 h-72 bg-amber-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '4s' }} />
          <div className="absolute bottom-20 left-[10%] w-96 h-96 bg-primary/10 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s', animationDelay: '2s' }} />
          
          <div className="container relative mx-auto px-4 py-20 md:py-32">
            <div className="max-w-5xl mx-auto">
              {/* Badge */}
              <div 
                className="inline-flex items-center gap-2 bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-700 dark:text-amber-400 px-5 py-2.5 rounded-full text-sm font-medium mb-8 opacity-0 animate-fade-in"
              ...
              {/* Main Headline */}
              <h1 
                className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold tracking-tight mb-6 opacity-0 animate-fade-in"
              ...
              {/* Subheadline */}
              <p 
                className="text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-2xl mb-10 leading-relaxed opacity-0 animate-fade-in"
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-amber-700 hover:bg-amber-800 text-white h-14 px-8 text-lg rounded-full shadow-lg shadow-amber-700/20 hover:shadow-xl hover:shadow-amber-800/25 transition-all duration-300 hover:-translate-y-0.5"
              ...
              {/* Stats Row */}
              <div 
                className="flex flex-wrap gap-8 md:gap-16 opacity-0 animate-fade-in"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {features.map((feature, index) => (
                <Card 
                  key={index} 
                  className={`group relative overflow-hidden border-0 bg-card/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1 ${
            ...
            <div className="max-w-2xl mx-auto">
              <Card className="relative overflow-hidden border-0 shadow-2xl bg-gradient-to-b from-card via-card to-amber-50/20 dark:to-amber-950/10">
                ...
                <CardContent className="pb-12 px-8">
                  <Button 
                    size="lg" 
                    className="w-full mb-10 text-lg h-16 bg-amber-700 hover:bg-amber-800 text-white rounded-xl shadow-lg shadow-amber-700/15 hover:shadow-xl hover:shadow-amber-800/20 transition-all duration-300" 
                    onClick={() => setShowInstitutionDialog(true)}
                  >
                    <Building2 className="h-5 w-5 mr-2" />
                    Contact ACFE Team
                  ...
                  <div className="space-y-4">
                    ...
                    {[
                      ...
                      <div 
                        key={index} 
                        className="flex items-center gap-4 p-3 rounded-lg hover:bg-amber-50/50 dark:hover:bg-amber-950/20 transition-colors"
                      >
        ...
        <section className="py-24 md:py-32 relative overflow-hidden">
          ...
          <div className="container relative mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Button 
                size="lg" 
                className="bg-white hover:bg-amber-50 text-amber-800 h-16 px-10 text-lg rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-1"
                onClick={() => setShowInstitutionDialog(true)}
              >
                Get Started Today
                <ArrowRight className="h-5 w-5 ml-2" />

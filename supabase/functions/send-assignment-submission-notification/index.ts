...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f4f4f5;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background-color: #ffffff; padding: 32px; border-radius: 0 0 12px 12px;">
      <h1 style="margin: 0 0 20px 0; font-size: 24px; color: #18181b;">New Assignment Submission 📝</h1>
      
      <p style="color: #3f3f46;">Hello ${mentorProfile.full_name || 'Mentor'},</p>
      
      <p style="color: #3f3f46; line-height: 1.6;"><strong>${studentName}</strong> has submitted an assignment that requires your review.</p>
      ...
      <p style="color: #3f3f46; line-height: 1.6;">Please review the submission and provide feedback to help the student progress in their learning journey.</p>
      
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://acloudforeveryone.org/dashboard" style="background: #4a5d4a; color: white; padding: 15px 30px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">Review Submission</a>
      </div>
    </div>
    ...
    await resend.emails.send({
      ...
      subject: `New Assignment Submission: ${courseTitle}`,
      html: htmlContent,
    });
